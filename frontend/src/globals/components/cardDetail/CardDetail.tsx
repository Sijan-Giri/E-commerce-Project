        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4">
              <h2 className="text-3xl font-bold mb-2">{singleProduct?.productName}</h2>
              <p className="text-gray-600 mb-4">SKU: WH1000XM4</p>
              <div className="mb-4">
                <span className="text-2xl font-bold mr-2">productPrice :-</span>
                <span className="text-gray-500">${singleProduct?.productPrice}</span>
              </div>
