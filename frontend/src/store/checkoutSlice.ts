...
import { ItemDetailsResponse, MyOrdersData, OrderData, OrderResponseData } from "../types/checkoutTypes";
...
export const {setStatus , setItems , setKhaltiUrl , setMyOrders} = checkoutSlice.actions;
