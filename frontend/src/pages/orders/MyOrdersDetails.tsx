...
const MyOrdersDetails = () => {
  ...
  const totalAmount = orderDetails?.reduce((total,order) => order?.Product?.productPrice + total , 0)
      ...
      <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
        <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 dark:bg-gray-800 space-y-6">
          ...
          <div className="flex justify-between items-center w-full">
            ...
            <p className="text-base dark:text-gray-300 font-semibold leading-4 text-gray-600">{totalAmount + 100}</p>
          </div>
        </div>
